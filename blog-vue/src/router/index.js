  ...
  routes: [
    {
      ...
      component: r =>
        require.ensure(
          [],
          () => r(require("@/views/blog/BlogWrite")),
          "blogwrite"
        ),
      meta: {
        requireLogin: true
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          path: "/log",
          component: r =>
            require.ensure([], () => r(require("@/views/Log")), "log")
        },
        {
          ...
          component: r =>
            require.ensure(
              [],
              () => r(require("@/views/blog/BlogArchive")),
              "archives"
            )
        },
        {
        ...
        },
        {
          ...
          component: r =>
            require.ensure(
              [],
              () => r(require("@/views/blog/BlogAllCategoryTag")),
              "blogallcategorytag"
            )
        },
        {
          ...
          component: r =>
            require.ensure(
              [],
              () => r(require("@/views/blog/BlogCategoryTag")),
              "blogcategorytag"
            )
        }
      ]
