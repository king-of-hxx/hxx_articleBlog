      ...
      <el-main>
        ...
        <div class="me-view-card">
          ...
          <div class="me-view-author">
            <a class="">
              <img class="me-view-picture" :src="getSrc(article.avatar)"></img>
            </a>
            ...
            <el-button v-if="this.article.author.id == this.$store.state.id" @click="editArticle()" style="position: absolute;left: 60%;" size="mini" round icon="el-icon-edit">编辑</el-button>
          </div>
          ...
          <div class="me-view-comment">
            <div class="me-view-comment-write">
              <el-row :gutter="20">
                ...
                <el-col :span="22">
                  <el-input type="textarea" :autosize="{ minRows: 2}" placeholder="你的评论..." class="me-view-comment-text" v-model="comment.content" resize="none">
                  </el-input>
                </el-col>
              </el-row>
            ...
            <commment-item v-for="(c,index) in comments" :comment="c" :articleId="article.id" :index="index" :rootCommentCounts="comments.length" @commentCountsIncrement="commentCountsIncrement" @getCommentsByArticle="getCommentsByArticle" :key="c.id">
            </commment-item>
  ...
  methods: {
    ...
    getArticle() {
      ...
      viewArticle(that.$route.params.id).then(data => {
        ...
        that.article.avatar = data.data.avatar
