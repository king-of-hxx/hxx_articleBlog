<template>
  <div class="me-view-comment-item">
    <div class="me-view-comment-author">
      <a class="">
        <img class="me-view-picture" :src="getSrc(comment.author.avatar)"></img>
      </a>
    ...
    <div>
      ...
      <div class="me-reply-list">
        ...
        <div class="me-view-comment-write" v-show="commentShow">
          ...
          <el-input v-model="reply.content" type="input" style="width: 90%" :placeholder="placeholder" class="me-view-comment-text" resize="none">
          </el-input>
